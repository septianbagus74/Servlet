...
<!--Kode Navbar-->
        ...
        <!--Akhir Navbar-->
	<form action="UpdateDataMahasiswa" method="POST">
	...
	<table align="center">
		<thead>
			...
			<tr>
				<td>Nama</td>
				<td>:</td>
				<td><input value="${nama}" type="text" name="nama" class="form-control"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<select name="jk" class="form-control">
					<option value="${jk}">---Pilih JK---</option>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<select name="id_rayon" class="form-control" value="${rayon}">
			...
			<tr>
				<td>Alamat</td>
				<td>:</td>
				<td><textarea name="alamat" class="form-control">${alamat}</textarea></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<option value="${fakultas} }">---Pilih Fakultas---</option>
					<% 
			...
			<tr>
				<td>Angkatan</td>
				<td>:</td>
				<td><input value="${angkatan}" type="number" name="angkatan" class="form-control"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<option value="${eskul}">----Pilih Eskul----</option>
					<% 
			...
			<tr>
				<td>Prestasi</td>
				<td>:</td>
				<td><textarea name="prestasi" class="form-control">${prestasi}</textarea></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<select name="id_dosen" class="form-control" value="${dosen}">
			...
			<tr>
				<td>Nilai</td>
				<td>:</td>
				<td><input type="number" name="nilai" class="form-control" value="${nilai}"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
