...
<!--Kode Navbar-->
        ...
        <!--Akhir Navbar-->
	<form action="UpdateDataEskul" method="POST">
	...
	<table align="center">
		<thead>
			<tr>
				<td>Eskul</td>
				<td>:</td>
				<td><input type="text" name="eskul" class="form-control" value="${eskul}"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				<td>Pembimbing</td>
				<td>:</td>
				<td><input type="text" name="pembimbing" class="form-control" value="${pembimbing}"></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
